package com.pitong.house.comment.exception;

import com.google.common.collect.ImmutableMap;
import com.pitong.house.comment.common.RestCode;

public class Exception2CodeMap {

	private static final ImmutableMap<Object, RestCode> MAP = ImmutableMap.<Object, RestCode>builder()
			.put(IllegalParamsException.Type.WRONG_PAGE_NUM, RestCode.WRONG_PAGE).build();
